...
boxCover.addEventListener("click", function() {
    if (boxCover.classList.contains("open")) {
        label.innerHTML = "Are you tired Angie? I have a gift for you.";
...
character.addEventListener("click", function() {
    if (character.classList.contains("first")) {
        label.innerHTML = "I hope you have a good day. I'd like to give you something.";
        ...
        label.innerHTML = "Here's a flower for you.";
